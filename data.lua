...
D.STRATA = {
  {
    ...
    creatures = { { id = "shalecrawler", w = 2 }, { id = "grit_tick", w = 3 } },
  ...
  },
  {
    ...
    creatures = { { id = "shalecrawler", w = 2 }, { id = "grit_tick", w = 4 } },
  ...
  },
  {
    ...
    creatures = { { id = "shalecrawler", w = 2 }, { id = "wallgnaw", w = 5 }, { id = "grit_tick", w = 3 } },
